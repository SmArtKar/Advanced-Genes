...
{
    public class Gene_BloodRegen : Gene
    {
        public override void Tick()
        {
            ...
            if (this.pawn.IsHashIntervalTick(60))
            {
                ...
                {
                    HealthUtility.AdjustSeverity(pawn, HediffDefOf.BloodLoss, -0.00033333333f); // By default, 0.00033333333f is lost every 60th tick
                }
            }
        }
    }
